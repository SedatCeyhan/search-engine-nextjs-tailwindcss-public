  ...
  return (
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        <Avatar
          className="ml-auto"
          url={"https://media-exp1.licdn.com/dms/image/C4E03AQFoo0No57ol9Q/profile-displayphoto-shrink_200_200/0/1594851919008?e=1631750400&v=beta&t=69v-SaijbUrfFJqQpbXm6U57dt987izAdgRaPipPHyc"}
        />
      </div>

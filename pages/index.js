    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <Avatar url={"https://media-exp1.licdn.com/dms/image/C4E03AQFoo0No57ol9Q/profile-displayphoto-shrink_200_200/0/1594851919008?e=1631750400&v=beta&t=69v-SaijbUrfFJqQpbXm6U57dt987izAdgRaPipPHyc"} />
        </div>
      </header>
